            	...
            	<form action="" method="post">
            		<table>
            			...
            			<tr>
            				...
            				<td><input type="text" name="ct1" placeholder="Enter 1st class test mark"></td>
            			</tr>
                              <tr>
                                    <td>Second Class Test</td>
                                    <td><input type="text" name="ct2" placeholder="Enter 2nd class test mark"></td>
                              </tr>
                              <tr>
                                    <td>Third Class Test</td>
                                    <td><input type="text" name="ct3" placeholder="Enter 3rd class test mark"></td>
                              </tr>
            			<tr>
            				<td></td>
